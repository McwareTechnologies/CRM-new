			...
			<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
				<thead>
					...
					<tr>
						...
						<td>
							<?php echo $rows['leadstatus'];?>
						</td>
						<td>
							<?php echo $rows['action'];?>
							<a href='editsales.php?editsalesid=<?php echo $rows['lead_ID'];?>'>
								<button type="button" class="btn btn-outline-secondary btn-sm"><i class="far fa-edit"></i>
								</button>
							</a>
							<a href='deletesale.php?id=<?php echo $rows['lead_ID'];?>'>
